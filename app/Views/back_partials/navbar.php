    ...
    <div class="container-fluid">
        <div id="navigation">
            ...
            <ul class="navigation-menu">
                ...
                <li>
                    <a href="<?= base_url('rahasia/lengkapi-pendaftaran') ?>"><i class="mdi mdi-airplay"></i>Lengkapi Pendaftaran</a>
                </li>
                <?php endif; ?>
                <?php if ($session->get('user_role') != 3) : ?>
                <li>
                    <a href="<?= base_url('rahasia/manajemen-siswa') ?>"><i class="mdi mdi-layers"></i>Manajemen
                        Siswa</a>
                </li>
                <li>
                    <a href="<?= base_url('rahasia/manajemen-kelas') ?>"><i class="mdi mdi-gauge"></i>Manajemen
                        Kelas</a>
                </li>
                <li>
