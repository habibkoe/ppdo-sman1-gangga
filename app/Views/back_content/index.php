        ...
        <div class="d-flex flex-row">
          ...
          <div class="col-9 align-self-center text-center">
            <div class="m-l-10">
              ...
              <p class="mb-0 text-muted">Jml Pelamar</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="d-flex flex-row">
          ...
          <div class="col-9 text-center align-self-center">
            <div class="m-l-10 ">
              ...
              <p class="mb-0 text-muted">Jml diterima</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="d-flex flex-row">
          ...
          <div class="col-9 align-self-center text-center">
            <div class="m-l-10 ">
              ...
              <p class="mb-0 text-muted">Jml belum lengkap</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="row">
  <div class="col-md-12 col-lg-12 col-xl-8">
    <div class="card m-b-30">
      <div class="card-body">
        <h5 class="header-title pb-3 mt-0">Peminat Jurusan</h5>
  ...
  <div class="col-md-12 col-lg-12 col-xl-4">
    <div class="card m-b-30">
      <div class="card-body">
        ...
        <h5 class="header-title mt-0 pb-3">Pelamar by Jenis Kelamin</h5>
...
<div class="row">
  <div class="col-md-12 col-lg-6 col-xl-8">
    <div class="card bg-white m-b-30">
      ...
      <h5 class="header-title mb-4 mt-0">Artikel terbaru</h5>
  ...
  <div class="col-md-12 col-lg-12 col-xl-4">
    <div class="card bg-white m-b-30">
      <img src="<?= base_url('theme/back/assets/images/widgets/wather.jpg')?>" alt="" class="img-fluid">
