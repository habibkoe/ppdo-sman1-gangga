<?php if(count($data_orang_tua) > 0): ?>
    <?php if(isset($addData) && $addData == 2): ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <select class="form-control select2 custom-select" style="width: 100%; height:36px !important;" id="agama_ortu"
                    name="agama_ortu">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <select class="form-control select2 custom-select" style="width: 100%; height:36px !important;" id="status_ortu"
                    name="status_ortu">
